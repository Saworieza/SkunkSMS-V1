...
class ResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create result" do
    assert_difference('Result.count') do
      post results_url, params: { result: { exam_id: @result.exam_id, student_id: @result.student_id } }
    end
  ...
  test "should update result" do
    patch result_url(@result), params: { result: { exam_id: @result.exam_id, student_id: @result.student_id } }
