...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post terms_url, params: { term: { academic_year_id: @term.academic_year_id, name: @term.name } }
    end
  ...
  test "should update term" do
    patch term_url(@term), params: { term: { academic_year_id: @term.academic_year_id, name: @term.name } }
